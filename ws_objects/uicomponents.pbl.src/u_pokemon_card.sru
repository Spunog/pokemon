...
// Download Avatar Image and display
//		this code isn't ideally placed here, will update later

u_service_file l_u_service_file
l_u_service_file = create u_service_file
String ls_downloaded_file, ls_url
str_response l_str_response

l_str_response = l_u_service_file.of_download_file_from_url(this.i_u_pokemon.of_get_sprite_front(), '')

if l_str_response.success then
	this.p_profile_pic.picturename = l_str_response.result
end if
